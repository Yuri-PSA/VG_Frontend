...
async function loadCardDetails(card) {
    ...
    try {
        ...
        const response = await fetch(`${API}/api/solicitudes/detalle?folio=${encodeURIComponent(folio)}&vista=Colaborador`, {
            method: 'GET',
            headers: {
                'Authorization': `Bearer ${token}`,
                'Content-Type': 'application/json',
...
async function fetchFinanzas() {
    try {
        ...
        const response = await fetch(`${API}/api/solicitudes/estado-financiero`, {
...
async function cancelRequest(folio, elemento) {
    ...
    showLoader();
    try {
        const response = await fetch(`${API}/api/solicitudes/cancelar`, {
            method: 'PATCH',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${token}`
